...
let
  ...
  gems = {
    ...
    "opentelemetry-instrumentation-action_mailer" =
      build "opentelemetry-instrumentation-action_mailer" "0.6.1";
    "opentelemetry-instrumentation-action_pack" =
      build "opentelemetry-instrumentation-action_pack" "0.15.1";
    "opentelemetry-instrumentation-action_view" =
      build "opentelemetry-instrumentation-action_view" "0.11.2";
    "opentelemetry-instrumentation-active_job" =
      build "opentelemetry-instrumentation-active_job" "0.10.1";
    "opentelemetry-instrumentation-active_model_serializers" =
      build "opentelemetry-instrumentation-active_model_serializers" "0.24.0";
    "opentelemetry-instrumentation-active_record" =
      build "opentelemetry-instrumentation-active_record" "0.11.1";
    "opentelemetry-instrumentation-active_storage" =
      build "opentelemetry-instrumentation-active_storage" "0.3.1";
    "opentelemetry-instrumentation-active_support" =
      build "opentelemetry-instrumentation-active_support" "0.10.1";
    "opentelemetry-instrumentation-base" = build "opentelemetry-instrumentation-base" "0.25.0";
    "opentelemetry-instrumentation-concurrent_ruby" =
      build "opentelemetry-instrumentation-concurrent_ruby" "0.24.0";
    ...
    "opentelemetry-instrumentation-http_client" =
      build "opentelemetry-instrumentation-http_client" "0.27.0";
