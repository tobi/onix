---
name: nix-ruby-build
description: Fix failing Ruby gem Nix builds by writing overlays. Use when `onix build` or `just build` reports gem failures and logs. Covers diagnosing build errors, writing overlays, and rebuild/verify loops.
---
...
Fix with: /nix-ruby-build skill — refer to /tmp/gem-build-XXXXXX.log
```
